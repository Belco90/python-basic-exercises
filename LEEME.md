...
![fork project](https://i.imgur.com/ZMnnWOb.png) ¡Github te redireccionará al mismo proyecto pero _duplicado_ en tu propia cuenta! Así podrás trabajar en él y subir tus cambios a tu propio repositorio (el proyecto _python-basics-exercises_ habrá aparecido en vuestra cuenta, puedes comprobarlo más tarde).
